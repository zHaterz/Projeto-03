...
Alimentos = {'Alimentos_Saude' : 'Maçã' 'Uva' 'Alface' 'Tomate',
'Alimentos_Gorduroso': 'Coxinha' 'Bacon' 'Ovo' 'Hamburg',  'Bebidas' : 'Suco de uva' 'Suco de Caju' 'Guarana' 'Coca-Cola'
}


saude = Alimentos['Alimentos_Saude']
